...
impl FraudPreventionContract {
    ...
    pub fn verify_view(
        ...
        let mut cache: VerificationCache = env
            .storage()
            .temporary()
            .get(&cache_key)
    ...
    fn _generate_view_id(env: &Env, campaign_id: u64, publisher: &Address, viewer: &Address) -> BytesN<32> {
